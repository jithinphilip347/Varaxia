      ...
      <article className="blog-content px-6 md:px-10 max-w-4xl mx-auto mb-24">
        ...
        <div className="mb-16">
          ...
          <ul className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {blogPost.lists.map((item, i) => (
              <li
                key={i}
                className="flex items-center gap-3 text-sm font-bold uppercase tracking-wide text-white"
              >
        ...
        <div className="flex gap-4 mb-20">
          ...
          {["Design", "Development", "Marketing"].map((tag) => (
            <span
              key={tag}
              className="text-white text-sm font-bold uppercase hover:text-[#d0fd3e] cursor-pointer transition-colors"
            >
              #{tag}
            </span>
          ))}
          ...
          <form className="space-y-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="space-y-2">
                ...
                <input
                  type="text"
                  className="w-full bg-transparent border-b border-white/20 py-4 focus:border-[#d0fd3e] outline-none transition-colors text-white text-lg"
            ...
            <div className="space-y-2">
              ...
              <textarea
                rows="4"
                className="w-full bg-transparent border-b border-white/20 py-4 focus:border-[#d0fd3e] outline-none transition-colors text-white text-lg resize-none"
                placeholder="Write your comment..."
              ></textarea>
            </div>
            <button
              type="button"
              className="bg-white text-black px-10 py-4 !rounded-none font-black uppercase tracking-widest hover:bg-neutral-200 transition-colors shadow-none"
            >
              Post Comment
            </button>
          </form>
