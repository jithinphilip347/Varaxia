...
export default function Contact() {
  ...
  return (
    <main
      ref={containerRef}
      className="bg-[#0e0e0e] text-white min-h-screen pt-24 md:pt-32 pb-10"
    >
      <Header />
      ...
      <section className="px-6 md:px-10 mb-16 md:mb-32 text-center max-w-4xl mx-auto">
        ...
        <p className="contact-title text-xs md:text-sm lg:text-lg text-neutral-400 max-w-xl md:max-w-2xl mx-auto leading-relaxed">
          Have a project in mind? Need help with branding, web design, or
          digital marketing? Let's discuss how we can bring your ideas to life.
        </p>
      </section>
      ...
      <section className="px-6 md:px-10 mb-20 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-24">
        ...
        <div className="contact-form bg-[#1a1a1a] p-6 md:p-12 rounded-2xl md:rounded-[2rem] border border-white/5 shadow-2xl">
          <h3 className="text-2xl md:text-3xl font-black uppercase tracking-tighter mb-6 md:mb-8">
            Send a Message
          </h3>
          ...
          <form className="flex flex-col gap-5 md:gap-6">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full bg-black/30 border border-white/10 rounded-xl px-4 md:px-5 py-3 md:py-4 focus:outline-none focus:border-[#d0fd3e] focus:bg-black/50 transition-all text-sm"
                  />
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <textarea
                  ...
                  className="w-full bg-black/30 border border-white/10 rounded-xl px-4 md:px-5 py-3 md:py-4 focus:outline-none focus:border-[#d0fd3e] focus:bg-black/50 transition-all text-sm resize-none"
                ></textarea>
            ...
            <button
              type="button"
              className="group mt-2 bg-white hover:bg-neutral-200 text-black font-black uppercase tracking-widest py-4 md:py-5 !rounded-none transition-all flex items-center justify-center gap-3 text-sm shadow-none"
            >
              Submit Project
      ...
      {/* 3. Map Section */}
      <section className="w-full px-0 md:px-0 mb-[-1px]">
        {" "}
        {/* mb-[-1px] to fix potential gap */}
