...
const testimonials = [
  ...
  {
    text: "The level of creativity and technical expertise Varaxia brings to the table is unmatched. They transformed our vision into a digital reality that exceeded our expectations.",
    name: "MARCUS REID",
    role: "CREATIVE DIRECTOR",
    image: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?q=80&w=200&auto=format&fit=crop"
  },
  {
    text: "Reliable, innovative, and truly dedicated to their craft. Working with Varaxia has been a game-changer for our brand's online presence.",
    name: "SOPHIA LI",
    role: "MARKETING HEAD",
...
export default function Testimonials() {
  ...
  return (
    <section ref={containerRef} className="py-24 px-6 bg-[#0e0e0e] text-white overflow-hidden relative">
              ...
              <div className="flex flex-col items-center pb-6">
                ...
                <div className="testimonial-author flex items-center justify-center gap-5 mt-2">
                   ...
                   <div className="text-left">
                      <h4 className="text-lg md:text-xl font-black uppercase tracking-wide leading-none mb-2">{item.name}</h4>
                      <div className="text-[10px] md:text-xs font-bold text-neutral-500 uppercase tracking-widest leading-none">{item.role}</div>
                   </div>
                </div>
              </div>
            </SwiperSlide>
